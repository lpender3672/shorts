...
print(x[0],np.round(YHat[0],1),y[0])
print(x[1],np.round(YHat[1],1),y[1])
print(x[2],np.round(YHat[2],1),y[2])
print(x[3],round(YHat[3][0],1),y[3])
#print(x[4],YHat[4],y[4])
print(NN.forward([0.05]))
